...
import ActionControls from "../virtualPet/ActionControls";
import StatusIndicators from "../virtualPet/StatusIndicators";
import type { VirtualPetState } from "../../types/pet-types";

interface TamaWebDeviceProps {
...
const TamaWebDevice: React.FC<TamaWebDeviceProps> = ({
  gameState,
  onAction,
  onReset,
  onNavigate,
